...
build_reusable_wf=".github/workflows/reusable-image-build.yml"
...
check_contains "$build_wf" "uses: ./.github/workflows/reusable-image-build.yml"
check_contains "$build_wf" "concurrency"
check_contains "$build_reusable_wf" "workflow_call"
check_contains "$build_reusable_wf" "matrix"
check_contains "$build_reusable_wf" "concurrency"
check_contains "$build_reusable_wf" "hashicorp/setup-packer"
check_contains "$build_reusable_wf" "pip3 install \"ansible"
check_contains "$build_reusable_wf" "id-token: write"
check_contains "$build_reusable_wf" "manifest.json"
check_contains "$build_reusable_wf" "cis-report.json"

check_contains "$promote_wf" "environment: prod"
check_contains "$promote_wf" "target_channel"
check_contains "$promote_wf" "promote"
check_contains "$promote_wf" "concurrency"
...
check_contains "$terratest_wf" "concurrency"
...
check_contains "$os_examples_wf" "concurrency"
